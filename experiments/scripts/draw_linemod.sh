...
python3 ./tools/draw_linemod.py --data_root ./datasets/linemod/Linemod_preprocessed/data/02\
  --item 0001\
  --seg_root ./datasets/linemod/Linemod_preprocessed/segnet_results/02_label\
  --obj 2\
  --model_root ./datasets/linemod/Linemod_preprocessed/models\
  --model ./trained_models/linemod/pose_model_9_0.01310166542980859.pth\
  --refine_model ./trained_models/linemod/pose_refine_model_493_0.006761023565178073.pth\
  --output ./
