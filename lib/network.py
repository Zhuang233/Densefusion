...
class PoseNet(nn.Module):
    def __init__(self, num_points, num_obj, sam_num2):
        ...
        self.conv1_r = torch.nn.Conv1d(1472, 736, 1)
        self.conv1_t = torch.nn.Conv1d(1472, 736, 1)
        self.conv1_c = torch.nn.Conv1d(1472, 736, 1)

        self.conv2_r = torch.nn.Conv1d(736, 256, 1)
        self.conv2_t = torch.nn.Conv1d(736, 256, 1)
        self.conv2_c = torch.nn.Conv1d(736, 256, 1)
